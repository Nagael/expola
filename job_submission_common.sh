...
if [ $1 == "MGS" ]; then
    python3 ./run_all.py --algo mgs --exec ../pola/gs_${ARCH}/main_qr__time.exe -- ${OTHER:=}
elif [ $1 == "A2V" ]; then
    python3 ./run_all.py --algo a2v --exec ../pola/hh_${ARCH}_A2V/main_a2v__time.exe -- ${OTHER:=}
elif [ $1 == "V2Q" ]; then
    python3 ./run_all.py --algo v2q --exec ../pola/hh_${ARCH}_V2Q/main_v2q__time.exe -- ${OTHER:=}
else
